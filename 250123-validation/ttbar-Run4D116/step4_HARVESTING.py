...
# with command line options: step4 -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --conditions auto:phase2_realistic_T33 --mc --geometry ExtendedRun4D116 --scenario pp --filetype DQM --era Phase2C17I13M9 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root --nThreads 10
